...
class EditPost : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnAddPostSave.setOnClickListener {
            ...
            val updatedTitle = binding.etEditPostTitle.text.toString()
            val updatedContent = binding.etAddPostContent.text.toString()
            val updatedLocation = binding.etEditPostLocation.text.toString()
            val writer = Firebase.auth.currentUser?.uid.toString()
            //return Post(postId, updatedTitle, updatedContent, "", updatedLocation,false)
            val updatedPost = Post(postId,updatedTitle,writer,updatedContent,updatedImage,updatedLocation)
